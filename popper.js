function Pop(){var cssRuleFile="https://raw.githubusercontent.com/oktob/css/main/style.css";let lnk=document.createElement("link");lnk.setAttribute("rel","stylesheet");lnk.setAttribute("type","text/css");lnk.setAttribute("href",cssRuleFile);document.getElementsByTagName("head")[0].appendChild(lnk);let styl="undefined";var conDivObj;var fadeInTime=10;var fadeOutTime=10;let cookie={name:"cookieconsent_status",path:"/",expiryDays:365*24*60*60*5000,};let content={message:"Ce site web utilise des cookies pour vous garantir la meilleure expérience possible sur notre site web.",btnText:"j'ai compris!",mode:"  banner bottom",theme:" theme-classic",palette:" palette1",link:"En savoir plus",href:"https://www.santeastuce.com/p/privacy-policy.html",target:"_blank",};let createPopUp=function(){console.log(content);if(typeof conDivObj==="undefined"){conDivObj=document.createElement("DIV");conDivObj.style.opacity=0;conDivObj.setAttribute("id","spopupCont");}
